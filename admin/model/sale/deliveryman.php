<?php
class ModelSaleDeliveryman extends Model {
    ...
    public function addDeliveryman($data) {
        ...
        $sql = "INSERT INTO " . DB_PREFIX . "deliveryman SET deliveryman_no = '" . $this->db->escape($data['deliveryman_no']) . "', `name` = '" . $this->db->escape($data['name']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', description = '" . $this->db->escape($data['description']) . "'";
    ...
    public function editDeliveryman($deliveryman_id, $data) {

        $sql = "UPDATE " . DB_PREFIX . "deliveryman SET deliveryman_no = '" . $this->db->escape($data['deliveryman_no']) . "', `name` = '" . $this->db->escape($data['name']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', description = '" . $this->db->escape($data['description']) . "' WHERE deliveryman_id = '" . (int)$deliveryman_id . "'";
    ...
    public function deleteDeliveryman($deliveryman_id) {
        $this->db->query("DELETE FROM " . DB_PREFIX . "deliveryman WHERE deliveryman_id = '" . (int)$deliveryman_id . "'");
    }
    ...
    public function getDeliveryman($deliveryman_id) {
        $query = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX . "deliveryman WHERE deliveryman_id = '" . (int)$deliveryman_id . "'");
    ...
    public function deliverymanCount($data = array()) {

        $sql = "SELECT COUNT(*) AS total FROM " . DB_PREFIX . "deliveryman";

        $implode = array();

        if (!empty($data['filter_no'])) {
            $implode[] = "deliveryman_no LIKE '%" . $this->db->escape($data['filter_no']) . "%'";
        }
    ...
    public function deliverymans($data = array()) {

        $sql = "SELECT * FROM " . DB_PREFIX . "deliveryman";
